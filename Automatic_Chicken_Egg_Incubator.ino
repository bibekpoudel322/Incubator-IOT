...
void displayMenu() {
  ...
  while (!exitMenu) {
    ...
    lcd.setCursor(0, 0);
    switch (menu) {
      case 0: lcd.print(">Set Temperature"); break;
      case 1: lcd.print(">Set Humidity"); break;
      case 2: lcd.print(">Set Temp Hysteresis"); break;
      case 3: lcd.print(">Set Temp Offset"); break;
      case 4: lcd.print(">View Status"); break;
      case 5: lcd.print(">Manual Turning"); break;
      case 6: lcd.print(">Factory Reset"); break;
      case 7: lcd.print(">Adjust Add Heat"); break;
      case 8: lcd.print(">Egg Turn Time"); break;
      case 9: lcd.print(">Egg Turn Once"); break;
      case 10: lcd.print(">Hum Calibration"); break;
      case 11: lcd.print(">Last Email Status"); break;
      case 12: lcd.print(">Test Relays"); break;
      case 13: lcd.print(">Connect to Wifi"); break;
      case 14: lcd.print(">Humidity Hysteresis"); break;
      case 15: lcd.print(">EXIT"); break;
    }
...
void executeAction() {
  switch (menu) {
    case 0: setTargetTemperature(); break;
    case 1: setTargetHumidity(); break;
    case 2: setHysteresis(); break;
    case 3: setOffset(); break;
    case 4: viewSystemStatus(); break;
    case 5: manualEggTurning(); break;
    case 6: factoryReset(); break;
    case 7: adjustAdditionalHeatingThreshold(); break;
    case 8: setEggTurningInterval(); break;
    case 9: setEggTurningDuration(); break;
    case 10: humidityCalibration(); break;
    case 11: viewLastEmailStatus(); break;
    case 12: testRelays(); break;
    case 13: connectWiFi(); break;
    case 14: setHumHysteresis(); break;
  }
}
...
void manualEggTurning() {
  ...
  while (true) {
    ...
    if (upPressed) {
      option--;
      if (option < 1) option = 3; // Wrap around to the last option
      delay(200);
    }

    if (downPressed) {
      option++;
      if (option > 3) option = 1; // Wrap around to the first option
      delay(200);
    }
  ...
  lcd.setCursor(0, 0);
    for (int i = 0; i < numNetworks; i++)
    {
        ...
        if (WiFi.status() == WL_CONNECTED)
        {
            ...
            Blynk.begin(auth, ssid[i], password[i]);
            return;
        }
    }
    lcd.setCursor(0,2);
...
BLYNK_WRITE(V3) { // Target temperature slider (Virtual Pin V2)
  targetTemp = param.asFloat();
  EEPROM.put(EEPROM_ADDR_TARGET_TEMP, targetTemp);
  EEPROM.commit();
}

BLYNK_WRITE(V2) { // Target humidity slider (Virtual Pin V3)
